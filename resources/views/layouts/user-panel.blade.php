<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">{{ __('userPanel.user_profile') }}
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{ Auth::user()->profile_image ? asset('storage/' . Auth::user()->profile_image) : asset('assets/media/svg/avatars/001-boy.svg') }}')"></div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    <a href="{{ route('admin.profile.show') }}" class="navi-item">
                    ...
                    <a type="button" href="{{ route('admin.profile.show') }}"
                        class="btn btn-sm btn-light font-weight-bolder py-2 px-5">
                      {{ __('userPanel.profile') }}
                    </a>
