        ...
        @foreach ($players as $index => $player)
            ...
            <tr>
                ...
                <td nowrap>
                    ...
                    <button class="btn btn-sm btn-clean btn-icon assign-program-btn"
                            data-player-id="{{ $player->id }}"
                            data-toggle="modal"
                            data-target="#assignProgramModal"
                            title="{{ __('player.actions.assign_program') }}">
                        <i class="la la-link"></i>
                    </button>

                    <a href="{{ route('admin.cards.scan', ['player_id' => $player->id]) }}"
                       class="btn btn-sm btn-clean btn-icon"
                    ...
                    @if (PermissionHelper::hasPermission('delete', App\Models\Player::MODEL_NAME))
                        <form action="{{ route('admin.players.destroy', $player->id) }}"
                            ...
                            @method('DELETE')
                            <button type="button"
                                    class="btn btn-sm btn-clean btn-icon delete-button"
