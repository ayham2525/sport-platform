...
@section('page_title')
    <h5 class="text-dark font-weight-bold my-2 mr-5">Edit Payment Method</h5>
@endsection
...
<div class="d-flex flex-column-fluid">
    <div class="container">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form action="{{ route('admin.payment-methods.update', $paymentMethod->id) }}" method="POST" class="form">
                @csrf
                @method('PATCH')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name_ar"
                                class="{{ $inputClass }} @error('name_ar') is-invalid @enderror"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name_ur"
                                class="{{ $inputClass }} @error('name_ur') is-invalid @enderror"
                                value="{{ old('name_ur', $paymentMethod->name_ur) }}"
