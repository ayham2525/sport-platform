...
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item">
            <span class="text-muted">{{ __('currency.actions.add') }}</span>
        </li>
    </ul>
@endsection
            ...
            <form method="POST" action="{{ route('admin.currencies.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="symbol" class="form-control" required value="{{ old('symbol') }}">
                    </div>
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save mr-1"></i> {{ __('currency.actions.add') }}
                    </button>
