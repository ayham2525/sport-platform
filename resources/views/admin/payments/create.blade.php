        ...
        <form method="POST" action="{{ route('admin.payments.store') }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <label><i class="la la-calendar mr-1"></i> {{ __('player.fields.payment_date') }}</label>
                    <input type="date" name="payment_date" class="form-control"
                           value="{{ old('payment_date', now()->format('Y-m-d')) }}" required>
                </div>
                <div class="form-group col-md-3">
                    <label><i class="la la-hourglass-start mr-1"></i> {{ __('player.fields.start_date') }}</label>
                    <input type="date" name="start_date" class="form-control" value="{{ old('start_date') }}">
                </div>
                <div class="form-group col-md-3">
                    <label><i class="la la-hourglass-end mr-1"></i> {{ __('player.fields.end_date') }}</label>
